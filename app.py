...
# Load and preprocess data with ACO feature selection and error handling
@st.cache_data
def load_and_preprocess_data():
    try:
        ...
        st.error(f"Error loading data: {str(e)}. Please ensure 'exoplanets.csv' is uploaded correctly.")
